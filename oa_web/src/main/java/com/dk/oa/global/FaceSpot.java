...
public class FaceSpot {
    private static final String AppID = "18104071";
    private static final String APIKey = "M42nAGi7TFFApVC2AG6BLIFI";
    private static final String SecretKey = "ywr1rehXZtGvNWg9s0AMVasxo8MGG2dO";
    ...
    // Base64参数
    public static JSONObject searchFace(String imgStr, String groupIdList, String userId) {
        String imageType = "BASE64";
        HashMap<String, String> options = new HashMap<String, String>();
        options.put("quality_control", "NORMAL");
        options.put("liveness_control", "LOW");
